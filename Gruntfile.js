...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    ...
    'linker/js/models/auctionModel.js',
    'linker/js/collections/auctionCollection.js',
    'linker/js/views/auctionView.js',
    'linker/js/views/auctionShowView.js',
    'linker/js/views/auctionCollectionView.js',
    'linker/js/routers/main.js',
